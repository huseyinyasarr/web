...
public static class SeedDatabase
{
    public static async void Initialize(IApplicationBuilder app)
    {
        ...
        {
            var customer = new AppUser { Name = "Yunus", UserName = "yunusyasar", Email = "yunus@gmail.com" };
            var admin = new AppUser { Name = "Huseyin", UserName = "huseyinyasarr", Email = "huseyin@gmail.com" };
